...
job_app = typer.Typer(help="Manage job identity in the registry.")
namespace_app = typer.Typer(help="Manage namespace identity in the registry.")
event_app = typer.Typer(help="Manage event type identity in the registry.")
