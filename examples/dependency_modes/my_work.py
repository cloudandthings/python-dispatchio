...
def best_effort_collector(run_id: str) -> None:
    print(f"best_effort_collector: all entities finished for {run_id}, collecting results.")
    time.sleep(0.2)


def majority_collector(run_id: str) -> None:
    print(f"majority_collector: threshold met for {run_id}, proceeding with majority results.")
    time.sleep(0.2)
